...
###############
        ...
        parser.add_argument('--save_dir', type=str, default='./output_mobile_load_init', help="")
        ...
        parser.add_argument('--restore_G_A_path', type=str, default='./pth_mobile_weight/numpy_0_net_G_A.pth', help="")
        parser.add_argument('--restore_G_B_path', type=str, default='./pth_mobile_weight/numpy_0_net_G_B.pth', help="")
        parser.add_argument('--restore_D_A_path', type=str, default='./pth_mobile_weight/numpy_0_net_D_A.pth', help="")
        parser.add_argument('--restore_D_B_path', type=str, default='./pth_mobile_weight/numpy_0_net_D_B.pth', help="")
