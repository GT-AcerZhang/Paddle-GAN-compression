...
##############
        ...
        parser.add_argument('--student_ngf', type=int, default=32, help="")  ### distiller
        ...
        parser.add_argument('--restore_pretrained_G_path', type=str, default='./pth_mobile_weight/numpy_latest_net_G_A.pkl', help="")
        parser.add_argument('--restore_student_G_path', type=str, default=None, help="")
        parser.add_argument('--restore_D_path', type=str, default='./pth_mobile_weight/numpy_latest_net_D_A.pkl', help="")
...
###############
        ...
        parser.add_argument('--save_dir', type=str, default='./output_distiller', help="")
