    ...
    def load_networks(self):
        if self.cfgs.restore_teacher_G_path is None:
            if self.cfgs.direction == 'AtoB':
                teacher_G_path = os.path.join(self.cfgs.save_dir, 'mobile', 'checkpoint', '{}_netG_A'.format(self.cfgs.mobile_epoch - 1))
            else:
                teacher_G_path = os.path.join(self.cfgs.save_dir, 'mobile', 'checkpoint', '{}_netG_B'.format(self.cfgs.mobile_epoch - 1))
        else:
        ...
        if self.cfgs.restore_student_G_path is not None:
            ...
            if self.task == 'supernet':
                student_G_path = os.path.join(self.cfgs.save_dir, 'distiller', 'checkpoint', '{}_stu_netG'.format(self.cfgs.distiller_epoch - 1))
